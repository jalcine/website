...
happening to them? Were lower quality images (like in the range of two megapixels)
...
easily contested. Again, I have questions: did the team have a large enough
collection of darker toned people to help circumvent if not avoid this
problem, if not equivalent in size, to photos of other people they have in their
